...
namespace MP2
{
    public class AutoLogin : IPlugin, IStartStopEvents, ITickEvents
    {
        ...
        public void Start()
        {
            _currentLoginDelay = Mp2AutoLoginSettings.Instance.LoginDelayInitial;
        ...
        private async Task<bool> Login()
        {
            ...
            var settings = Mp2AutoLoginSettings.Instance;
        ...
        public UserControl Control => _gui ??= new Mp2AutoLoginGui();
        public JsonSettings Settings => Mp2AutoLoginSettings.Instance;
