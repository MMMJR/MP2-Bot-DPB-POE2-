...
namespace MP2.EXtensions.Global
{
    public class ComplexExplorer
    {
        ...
        {
            if (_myLastPos.Distance >= 200 && !_myLastPos.PathExists)
            {
            ...
            if (_transition == null) _transition = FrontTransition;
        ...
        private static void MarkBackTransition()
        {
            ...
            var backTransition = CombatAreaCache.Current.AreaTransitions
                .Where(a => (a.Type == TransitionType.Local || a.Type == TransitionType.Regular) && !a.LeadsBack && !a.Visited && a.Position.Distance <= 50)
        ...
        private CachedTransition FrontTransition
        {
            get
            {
                return CombatAreaCache.Current.AreaTransitions.ClosestValid(t => (t.Type == TransitionType.Local || t.Type == TransitionType.Regular) && !t.Visited && !t.LeadsBack);
            }
        }

        private static CachedTransition BackTransition => CombatAreaCache.Current.AreaTransitions
            .Where(t => (t.Type == TransitionType.Local || t.Type == TransitionType.Regular) && !t.Visited)
            .ClosestValid();
    ...
    public class ExplorationSettings
    {
        ...
        (
            bool basicExploration = false,
            bool fastTransition = true,
            bool backtracking = true,
            bool openPortals = true,
