...
namespace MP2.EXtensions.Global
{
    public class CombatAreaCache
    {
        ...
        private void ProcessMonster(Monster m)
        {
            ...
            Monsters.Add(new CachedObject(id, pos, true));
            _processedObjects.Add(id);
        }
        ...
        private void ProcessChest(Chest c)
        {
            ...
            if (_processedObjects.Contains(id))
                return;
            if (c.Name == "Urn") return;
            if (c.Name == "Barrel") return;
            if (c.Name == "Pot") return;
            if (c.Name == "Barrel") return;
        ...
        private void ProcessTransition(AreaTransition t)
        {
            ...
            GlobalLog.Debug("Transition Found: " + t.Name + " / " + t.Id);
            ...
            //TweakTransition(ref cachedTrans);
        }
        ...
        {
            var m = mob.Metadata;
            return m.Contains("DoedreStonePillar");
        }
        ...
        private void TweakTransition(ref CachedTransition t)
        {
