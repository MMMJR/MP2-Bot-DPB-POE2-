...
namespace MP2.EXtensions.Tasks
{
    public class SortInventoryTask : ITask
    {
        ...
        private static Position GetMovePosForInventoryItem(Item item)
        {
            ...
            var currency = Mp2Settings.Instance.InventoryCurrencies.FirstOrDefault(i => i.Name == itemName);
        ...
        private static bool HasFixedPosition(Mp2Settings.InventoryCurrency item)
        {
