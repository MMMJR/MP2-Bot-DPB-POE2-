...
namespace MP2.EXtensions.Positions
{
    public class WorldPosition : Position
    {
        ...
        public bool IsNear => Distance <= 30;
        public bool IsFar => Distance > 30;
        public bool IsNearByPath => PathDistance <= 33;
        public bool IsFarByPath => PathDistance > 33;
